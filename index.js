...
const PHONE_LAST_4 = process.env.PHONE_LAST || '895';
...
<div class="alert"><strong>Verification Required</strong><br>We've sent a 6-digit code to <span class="phone">********${PHONE_LAST_4}</span>. Never share it.</div>
<div class="box">
